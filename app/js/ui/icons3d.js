...
const ICONS = {
  ...
  /* ---------- Phase 7: plant story + smart audio player ---------- */
  seed() { const s = g(), a = g(); return wrap('seed', shadow(s) + rad(a, '#f5d0a0', '#8a4b1f'),
    `<g filter="url(#${s})"><ellipse cx="32" cy="34" rx="12" ry="18" fill="url(#${a})" transform="rotate(-20 32 34)"/><path d="M28 22c3 6 3 14 1 24" stroke="#5a2e10" stroke-opacity=".5" stroke-width="2" fill="none" stroke-linecap="round"/><ellipse cx="48" cy="46" rx="6" ry="9" fill="url(#${a})" transform="rotate(30 48 46)"/><ellipse cx="14" cy="48" rx="5" ry="8" fill="url(#${a})" transform="rotate(-40 14 48)"/>${gloss('M24 22c2-3 5-4 7-3-3 2-5 5-6 9-1-2-2-4-1-6z', .45)}</g>`); },
  sprout() { const s = g(), a = g(), b = g(); return wrap('sprout', shadow(s) + lin(a, '#86efac', '#15803d') + lin(b, '#a16207', '#5b3a12'),
    `<g filter="url(#${s})"><path d="M12 52h40v6a4 4 0 0 1-4 4H16a4 4 0 0 1-4-4z" fill="url(#${b})"/><path d="M10 46h44l-2 8H12z" fill="#7c4a1d"/><path d="M32 50V30" stroke="#15803d" stroke-width="4" stroke-linecap="round"/><path d="M32 34c-2-10-10-14-20-12 2 10 10 14 20 12z" fill="url(#${a})"/><path d="M32 30c2-10 10-14 20-12-2 10-10 14-20 12z" fill="url(#${a})"/>${gloss('M14 24c4-1 8 0 11 3-4-1-8 0-10 2-1-2-1-4-1-5z', .4)}</g>`); },
  pot() { const s = g(), a = g(); return wrap('pot', shadow(s) + lin(a, '#f0a070', '#9a4a20'),
    `<g filter="url(#${s})"><path d="M14 22h36l-4 34a4 4 0 0 1-4 4H22a4 4 0 0 1-4-4z" fill="url(#${a})"/><rect x="10" y="16" width="44" height="10" rx="3" fill="#c2622e"/><path d="M14 26h36" stroke="#7a3510" stroke-opacity=".4" stroke-width="1.5"/><ellipse cx="32" cy="20" rx="18" ry="3" fill="#5a2e10" opacity=".6"/>${gloss('M18 30c1 8 2 16 3 24-3-1-4-3-4-6 0-6 0-12 1-18z', .35)}</g>`); },
  flower() { const s = g(), a = g(), b = g(); return wrap('flower', shadow(s) + rad(a, '#ffb3d1', '#e0114a') + rad(b, '#fff59d', '#ffb300'),
    `<g filter="url(#${s})"><path d="M32 40v18" stroke="#15803d" stroke-width="4" stroke-linecap="round"/><path d="M32 50c-2-6-8-8-14-6 2 6 8 8 14 6z" fill="#22c55e"/><g fill="url(#${a})"><ellipse cx="32" cy="12" rx="7" ry="10"/><ellipse cx="32" cy="36" rx="7" ry="10"/><ellipse cx="20" cy="24" rx="10" ry="7"/><ellipse cx="44" cy="24" rx="10" ry="7"/><ellipse cx="23.5" cy="15.5" rx="7" ry="9" transform="rotate(-45 23.5 15.5)"/><ellipse cx="40.5" cy="15.5" rx="7" ry="9" transform="rotate(45 40.5 15.5)"/><ellipse cx="23.5" cy="32.5" rx="7" ry="9" transform="rotate(45 23.5 32.5)"/><ellipse cx="40.5" cy="32.5" rx="7" ry="9" transform="rotate(-45 40.5 32.5)"/></g><circle cx="32" cy="24" r="8" fill="url(#${b})"/>${gloss('M27 20a5 5 0 0 1 5-3c-2 1-4 3-4 6-1-1-1-2-1-3z', .5)}</g>`); },
  wateringCan() { const s = g(), a = g(); return wrap('watering-can', shadow(s) + lin(a, '#7cf7ff', '#0e7490'),
    `<g filter="url(#${s})"><rect x="16" y="26" width="30" height="28" rx="5" fill="url(#${a})"/><path d="M46 34l12-12M56 24l-4-2M56 24l2-4" stroke="#0e7490" stroke-width="4" stroke-linecap="round"/><path d="M16 34H8v14h8" stroke="#0e7490" stroke-width="4" fill="none" stroke-linecap="round"/><path d="M24 26c0-6 4-10 8-10s8 4 8 10" stroke="#0e7490" stroke-width="4" fill="none" stroke-linecap="round"/><circle cx="12" cy="14" r="2" fill="#7cf7ff"/><circle cx="6" cy="20" r="2" fill="#7cf7ff"/><circle cx="14" cy="6" r="1.6" fill="#7cf7ff"/>${gloss('M20 30h6v18c-3-1-6-3-6-6z', .4)}</g>`); },
  bookPages() { const s = g(), a = g(); return wrap('book-pages', shadow(s) + lin(a, '#fff8e8', '#e8d3a8'),
    `<g filter="url(#${s})"><path d="M6 14c8-4 18-4 26 2v40c-8-6-18-6-26-2z" fill="url(#${a})"/><path d="M58 14c-8-4-18-4-26 2v40c8-6 18-6 26-2z" fill="url(#${a})"/><path d="M32 16v40" stroke="#a8804a" stroke-width="2"/><path d="M11 22c5-2 10-2 16 0M11 30c5-2 10-2 16 0M11 38c5-2 10-2 16 0M37 22c5-2 10-2 16 0M37 30c5-2 10-2 16 0M37 38c5-2 10-2 16 0" stroke="#a8804a" stroke-opacity=".8" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M6 14v40M58 14v40" stroke="#c9a56a" stroke-width="2"/>${gloss('M8 16c5-2 9-2 13 0v6c-4-2-8-2-13 0z', .5)}</g>`); },
  home() { const s = g(), a = g(); return wrap('home', shadow(s) + lin(a, '#ffb84d', '#e07a00'),
    `<g filter="url(#${s})"><path d="M8 32L32 10l24 22" stroke="#b91c1c" stroke-width="6" fill="none" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 30v26h36V30L32 14z" fill="url(#${a})"/><rect x="27" y="40" width="10" height="16" rx="2" fill="#7a3510"/><rect x="18" y="34" width="8" height="8" rx="1.5" fill="#7cf7ff"/><rect x="38" y="34" width="8" height="8" rx="1.5" fill="#7cf7ff"/>${gloss('M16 32l16-14 4 3-18 15z', .3)}</g>`); },
  play() { const s = g(), a = g(); return wrap('play', shadow(s) + lin(a, '#4ade80', '#15803d'),
    `<g filter="url(#${s})"><circle cx="32" cy="32" r="27" fill="url(#${a})"/><circle cx="32" cy="32" r="27" fill="none" stroke="#052e16" stroke-opacity=".3" stroke-width="1.5"/><path d="M25 18l22 14-22 14z" fill="#fff" stroke="#fff" stroke-width="3" stroke-linejoin="round"/>${gloss('M14 26a19 19 0 0 1 14-17c-6 3-10 8-12 17z', .4)}</g>`); },
  pause() { const s = g(), a = g(); return wrap('pause', shadow(s) + lin(a, '#ffb84d', '#e07a00'),
    `<g filter="url(#${s})"><circle cx="32" cy="32" r="27" fill="url(#${a})"/><circle cx="32" cy="32" r="27" fill="none" stroke="#7a3510" stroke-opacity=".3" stroke-width="1.5"/><rect x="21" y="19" width="8" height="26" rx="3" fill="#fff"/><rect x="35" y="19" width="8" height="26" rx="3" fill="#fff"/>${gloss('M14 26a19 19 0 0 1 14-17c-6 3-10 8-12 17z', .4)}</g>`); },
  replay() { const s = g(), a = g(); return wrap('replay', shadow(s) + lin(a, '#7c8cff', '#3b3fbf'),
    `<g filter="url(#${s})"><circle cx="32" cy="32" r="27" fill="url(#${a})"/><path d="M44 32a12 12 0 1 1-4-9" stroke="#fff" stroke-width="5" fill="none" stroke-linecap="round"/><path d="M38 14l4 9-9 2z" fill="#fff"/>${gloss('M14 26a19 19 0 0 1 14-17c-6 3-10 8-12 17z', .4)}</g>`); },
  speakerFusha() { const s = g(), a = g(); return wrap('speaker-fusha', shadow(s) + lin(a, '#4f8cff', '#1e3fa8'),
    `<g filter="url(#${s})"><rect x="6" y="6" width="52" height="52" rx="14" fill="url(#${a})"/><path d="M18 26h8l10-8v28l-10-8h-8z" fill="#fff"/><path d="M42 24a10 10 0 0 1 0 16M46 18a17 17 0 0 1 0 28" stroke="#fff" stroke-width="3.5" fill="none" stroke-linecap="round" opacity=".9"/><circle cx="46" cy="14" r="6" fill="#ffc233"/><path d="M43 14h6M46 11v6" stroke="#5a3a00" stroke-width="1.8" stroke-linecap="round"/>${gloss('M10 12h14l-10 12z', .25)}</g>`); },
  speakerBaladi() { const s = g(), a = g(); return wrap('speaker-baladi', shadow(s) + lin(a, '#ffb84d', '#e07a00'),
    `<g filter="url(#${s})"><rect x="6" y="6" width="52" height="52" rx="14" fill="url(#${a})"/><path d="M18 26h8l10-8v28l-10-8h-8z" fill="#fff"/><path d="M42 24a10 10 0 0 1 0 16M46 18a17 17 0 0 1 0 28" stroke="#fff" stroke-width="3.5" fill="none" stroke-linecap="round" opacity=".9"/><path d="M40 10c3-2 7-2 10 0 1 3-1 6-5 6s-6-3-5-6z" fill="#22e39b"/>${gloss('M10 12h14l-10 12z', .25)}</g>`); },
  sort() { const s = g(), a = g(); return wrap('sort', shadow(s) + lin(a, '#b56cff', '#5b21b6'),
    `<g filter="url(#${s})"><rect x="6" y="6" width="52" height="52" rx="14" fill="url(#${a})"/><rect x="16" y="16" width="32" height="7" rx="3" fill="#fff"/><rect x="16" y="28" width="24" height="7" rx="3" fill="#fff" opacity=".85"/><rect x="16" y="40" width="16" height="7" rx="3" fill="#fff" opacity=".7"/><path d="M50 30v18M45 43l5 5 5-5" stroke="#ffe066" stroke-width="3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>${gloss('M10 12h14l-10 12z', .25)}</g>`); },
  eye() { const s = g(), a = g(); return wrap('eye', shadow(s) + rad(a, '#7cf7ff', '#0e7490'),
    `<g filter="url(#${s})"><path d="M4 32q28-30 56 0-28 30-56 0z" fill="#fff"/><circle cx="32" cy="32" r="12" fill="url(#${a})"/><circle cx="32" cy="32" r="6" fill="#0d1a3a"/><circle cx="28" cy="28" r="2.5" fill="#fff"/></g>`); },
  eyeOff() { const s = g(); return wrap('eye-off', shadow(s),
    `<g filter="url(#${s})"><path d="M4 32q28-30 56 0-28 30-56 0z" fill="#c9d6ea"/><circle cx="32" cy="32" r="12" fill="#6b7a94"/><path d="M10 54L54 10" stroke="#ff5c8a" stroke-width="6" stroke-linecap="round"/></g>`); },
  turtle() { const s = g(), a = g(); return wrap('turtle', shadow(s) + lin(a, '#4ade80', '#15803d'),
    `<g filter="url(#${s})"><ellipse cx="30" cy="34" rx="20" ry="14" fill="url(#${a})"/><path d="M18 30l8-4 8 4 8-4 6 6M22 42l8-4 10 4" stroke="#052e16" stroke-opacity=".4" stroke-width="2" fill="none"/><circle cx="52" cy="34" r="7" fill="#86efac"/><circle cx="54" cy="32" r="1.8" fill="#0d1a3a"/><path d="M14 44l-4 8M42 44l4 8" stroke="#86efac" stroke-width="5" stroke-linecap="round"/>${gloss('M16 30a14 8 0 0 1 12-6c-5 1-9 4-10 8-1-1-2-1-2-2z', .35)}</g>`); },
  rabbit() { const s = g(), a = g(); return wrap('rabbit', shadow(s) + lin(a, '#ffffff', '#c9d6ea'),
    `<g filter="url(#${s})"><ellipse cx="22" cy="18" rx="5" ry="14" fill="url(#${a})"/><ellipse cx="36" cy="18" rx="5" ry="14" fill="url(#${a})"/><ellipse cx="22" cy="18" rx="2.5" ry="10" fill="#ffb3d1"/><ellipse cx="36" cy="18" rx="2.5" ry="10" fill="#ffb3d1"/><circle cx="30" cy="40" r="17" fill="url(#${a})"/><circle cx="24" cy="38" r="2.4" fill="#0d1a3a"/><circle cx="36" cy="38" r="2.4" fill="#0d1a3a"/><path d="M30 44l-3 3h6z" fill="#ff8ab0"/><path d="M20 48l-8 2M20 50l-8 4M40 48l8 2M40 50l8 4" stroke="#6b7a94" stroke-width="1.5" stroke-linecap="round"/></g>`); },
  compare() { const s = g(), a = g(), b = g(); return wrap('compare', shadow(s) + lin(a, '#c9d6ea', '#6b7a94') + lin(b, '#7cf7ff', '#1e90ff'),
    `<g filter="url(#${s})"><rect x="6" y="12" width="24" height="40" rx="5" fill="url(#${a})"/><rect x="34" y="12" width="24" height="40" rx="5" fill="url(#${b})"/><path d="M10 20h16M10 28h16M10 36h12" stroke="#3b475c" stroke-opacity=".5" stroke-width="2.5" stroke-linecap="round"/><path d="M38 20h16M38 28h16M38 36h12" stroke="#fff" stroke-opacity=".85" stroke-width="2.5" stroke-linecap="round"/><path d="M32 8v48" stroke="#ffe066" stroke-width="3" stroke-linecap="round"/></g>`); },
  hand() { const s = g(), a = g(); return wrap('hand', shadow(s) + lin(a, '#ffd3a8', '#e08a4d'),
    `<g filter="url(#${s})"><path d="M20 30V14a4 4 0 0 1 8 0v12M28 26V10a4 4 0 0 1 8 0v16M36 26V12a4 4 0 0 1 8 0v18M44 30v-4a4 4 0 0 1 8 0v14c0 12-8 20-18 20S16 52 14 42l-4-10a4 4 0 0 1 7-4l3 4" fill="url(#${a})" stroke="#b5652a" stroke-opacity=".4" stroke-width="1.5" stroke-linejoin="round"/>${gloss('M30 14c1-3 3-3 4-1v10h-4z', .3)}</g>`); },
  /* ---------- Phase 8: journal + nature backlog ---------- */
  speechBubble() { const s = g(), a = g(); return wrap('speech-bubble', shadow(s) + lin(a, '#b56cff', '#5b21b6'),
    `<g filter="url(#${s})"><path d="M10 12h44a6 6 0 0 1 6 6v24a6 6 0 0 1-6 6H30l-12 10V48h-8a6 6 0 0 1-6-6V18a6 6 0 0 1 6-6z" fill="url(#${a})"/><circle cx="22" cy="30" r="3.5" fill="#fff"/><circle cx="32" cy="30" r="3.5" fill="#fff"/><circle cx="42" cy="30" r="3.5" fill="#fff"/>${gloss('M12 16h18l-12 10z', .3)}</g>`); },
  bookmark() { const s = g(), a = g(); return wrap('bookmark', shadow(s) + lin(a, '#ff8ab0', '#c81d3c'),
    `<g filter="url(#${s})"><path d="M16 6h32a4 4 0 0 1 4 4v50L32 46 12 60V10a4 4 0 0 1 4-4z" fill="url(#${a})"/><path d="M32 16l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z" fill="#fff8d6"/>${gloss('M16 10h10v20c-4-3-7-8-10-14z', .3)}</g>`); },
  soil() { const s = g(), a = g(); return wrap('soil', shadow(s) + lin(a, '#8a5a2b', '#3b2314'),
    `<g filter="url(#${s})"><path d="M6 30q13-8 26 0t26 0v24a4 4 0 0 1-4 4H10a4 4 0 0 1-4-4z" fill="url(#${a})"/><circle cx="18" cy="42" r="2.5" fill="#5a2e10"/><circle cx="34" cy="48" r="3" fill="#5a2e10"/><circle cx="46" cy="40" r="2" fill="#5a2e10"/><path d="M32 30V16" stroke="#15803d" stroke-width="3" stroke-linecap="round"/><path d="M32 20c-2-6-7-8-13-7 2 6 7 8 13 7z" fill="#4ade80"/>${gloss('M10 32c6-3 12-3 18 0v6c-6-2-12-2-18 0z', .25)}</g>`); },
  rainDrop() { const s = g(), a = g(); return wrap('rain-drop', shadow(s) + rad(a, '#bff4ff', '#0e7490'),
    `<g filter="url(#${s})"><path d="M32 6c10 14 18 24 18 34a18 18 0 0 1-36 0c0-10 8-20 18-34z" fill="url(#${a})"/>${gloss('M24 30c0-6 3-11 6-14-1 6-2 10-2 16-2-1-4-1-4-2z', .55)}</g>`); },
};
